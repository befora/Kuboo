...
object Settings {
    ...
    const val DEFAULT_RECENTLY_VIEWED_HEIGHT_OFFSET = 0
    const val DEFAULT_READER_SCROLL_OFFSET = 0
    ...
    var RECENTLY_VIEWED_HEIGHT_OFFSET = DEFAULT_RECENTLY_VIEWED_HEIGHT_OFFSET

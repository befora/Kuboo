...
import static junrar.exception.RarException.RarExceptionType;
...
public class Archive implements Closeable {
    ...
    public Archive(VolumeManager volumeManager) throws
            IOException {
    ...
    public Archive(File firstVolume) throws IOException {
...
//        return in;
//    }
    public InputStream getInputStream(final FileHeader hd) {
